  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .ca-content-view p { margin: 0 0 10px; }
        .ca-content-view h1 { font-size: 1.4rem; font-weight: 800; margin: 16px 0 8px; }
        .ca-content-view h2 { font-size: 1.2rem; font-weight: 800; margin: 14px 0 8px; }
        .ca-content-view h3 { font-size: 1.05rem; font-weight: 700; margin: 12px 0 6px; }
        .ca-content-view ul, .ca-content-view ol { padding-left: 1.4rem; margin: 0 0 10px; }
